...
public class MessageServiceImpl implements MessageService {
    ...
    public Message saveMessage(Message message) {
        ...
        //设置当前回复的顶级parentMessage
        if (parentMessageId != -1) {
            //老旧的写法  messageRepository.findOne(parentMessageId)
            message.setParentMessage(messageRepository.getById(parentMessageId));
        } else {
    ...
    public void findParentMessage(Message message) {
        ...
        if(parentMessage == null){
            ...
            Message parent = messageRepository.getById(parentMessage.getId());
